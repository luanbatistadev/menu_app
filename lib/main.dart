...
class ThemeWidgetTest extends StatelessWidget {
  const ThemeWidgetTest({super.key, required this.child});
  final Widget child;

  @override
  Widget build(BuildContext context) {
    final textTheme = Theme.of(context).textTheme;
    final fontPoppins = TextStyle(fontFamily: 'Poppins');
          ...
          data: isLight
              ? ThemeData.light().copyWith(
                  ...
                  textTheme: textTheme.copyWith(
                    titleLarge: fontPoppins.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 20,
                      color: Color(0xff1B55F5),
                    ),
                    titleMedium: fontPoppins.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                      color: Color(0xff1B55F5),
                    ),
                    bodyMedium: fontPoppins.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black,
                    ),
                    bodySmall: fontPoppins.copyWith(
                      fontWeight: FontWeight.normal,
                      fontSize: 12,
                      color: Colors.black,
                    ),
                    bodyLarge: fontPoppins.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                      color: Colors.black,
                    ),
                    titleSmall: fontPoppins.copyWith(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.black,
                    ),
                    labelSmall: fontPoppins.copyWith(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.white,
                    ),
                    displaySmall: fontPoppins.copyWith(
                      color: Colors.white,
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
                    ),
