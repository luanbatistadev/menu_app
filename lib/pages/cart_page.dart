...
import 'package:menu_app/pages/history_shopping_page.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  Future<void> openBox() async {
    box = await Hive.openBox('orderHistoryBox');
  }
                  ...
                  leading: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const HistoryShoppingPage(),
                        ),
                      );
                    },
                    child: Icon(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => confirmSale(context, value),
                            child: Container(
                              padding: EdgeInsets.symmetric(
                                horizontal: 10,
                                vertical: 4,
